...
yum update
yum install libpq-devel sqlite-devel git python3-devel make gcc cmake clang vim ctags tbb-devel wget dos2unix libtool apr-devel apr-util-devel valgrind gdb
...
ln -s /usr/bin/python3 python; ./b2 --with-python --debug-configuration install
